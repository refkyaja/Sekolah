...
return [
    ...
    */
    ...
    | a users session to check if a new release has invalidated it. If there is
    ...
    */
    ...
    |---------------------------------------------------------------------------
    |
    | These settings control lazy loading behavior for Livewire components.
    | Useful for optimizing performance in production environments.
    |
    */

    'lazy_loading' => [
        'enabled' => env('LIVEWIRE_LAZY_LOADING', true),
        'placeholder' => 'livewire::loading-spinner',
    ],
    ...
    |---------------------------------------------------------------------------
    |
    | Enable additional debugging features in development environment.
    | This should be disabled in production for security and performance.
    |
    */
