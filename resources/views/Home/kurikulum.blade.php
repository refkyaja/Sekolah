...
<!-- Hero Section -->
<div class="w-full max-w-[1200px] px-6 mt-8 md:mt-16">
    <section data-kurikulum-animate="zoom-in" class="hero-section relative h-[300px] md:h-[400px] w-full overflow-hidden rounded-xl md:rounded-3xl shadow-lg">
        <div class="absolute inset-0 bg-cover bg-center" data-alt="Children playing happily in a colorful classroom" style="background-image: url('https://images.unsplash.com/photo-1503676260728-1c00da094a0b?q=80&w=1600&auto=format&fit=crop');"></div>
...
<img alt="Anak-anak belajar dengan gembira" class="w-full h-full object-cover transition-transform duration-700 hover:scale-110" data-alt="Children playing and learning in a colorful classroom environment" src="https://lh3.googleusercontent.com/aida-public/AB6AXuB_MquBOGLTbw883uKCbnUds56NWiPI2Gc98uPWJ7zQVLXq7P9W-i7C6Zhl2DRCDhvX3f-VufT38Cpz7PTg1ztihUbXH874fphj15hUiF0PC2iX_MASW5F6NeGtKUJA8WaGXDLQ870-AVhLeuwKO2YAK_giqUxN9ZxhJFnkMTlE8FJOnyG-g8WVz4L_nxQ-T_E432Y1_HQ9VNnJHBFHCLbtZmWwbDRA1HqZVL9oxUwhGEnIUugfnXm89tdKNLVCjcknorQ_mH32SeE"/>
</div>
</section>
