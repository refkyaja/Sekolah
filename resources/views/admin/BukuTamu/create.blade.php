...
<div class="max-w-4xl mx-auto">
    <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 overflow-hidden">
        <div class="p-8 border-b border-slate-50 dark:border-slate-700/50">
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h2 class="text-lg font-bold text-slate-800 dark:text-slate-100">Formulir Kunjungan</h2>
                    <p class="text-sm text-slate-500 dark:text-slate-400">Lengkapi data di bawah ini untuk mencatat tamu baru.</p>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="date" name="tanggal_kunjungan" id="tanggal_kunjungan" value="{{ old('tanggal_kunjungan', date('Y-m-d')) }}" required
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="tujuan_kunjungan" id="tujuan_kunjungan" value="{{ old('tujuan_kunjungan') }}" required
                                   class="w-full pl-12 pr-4 py-3 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary text-sm transition-all" 
                    ...
                    <div class="space-y-2 md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <textarea name="pesan_kesan" id="pesan_kesan" rows="4" required
                                      ...
                                      placeholder="Tuliskan pesan atau kesan kunjungan...">{{ old('pesan_kesan') }}</textarea>
                        </div>
                    </div>
    ...
    <div class="mt-8 flex items-center justify-center gap-6 opacity-60">
        <div class="flex items-center gap-2">
            <span class="material-symbols-outlined text-sm text-slate-400 dark:text-slate-500">verified_user</span>
            <span class="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest">Secure Entry</span>
        </div>
        <div class="flex items-center gap-2">
            <span class="material-symbols-outlined text-sm text-slate-400 dark:text-slate-500">history</span>
            <span class="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest">Auto Timestamp</span>
        </div>
    </div>
</div>
@endsection
