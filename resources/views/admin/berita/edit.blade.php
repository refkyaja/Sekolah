            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 dark:bg-slate-900/50 p-4 rounded-lg">
                        ...
                        <div class="border-2 border-dashed border-gray-300 dark:border-slate-500 rounded-lg hover:border-indigo-500 hover:bg-indigo-50 transition-all cursor-pointer group"
                             id="dropzone">
                    ...
                    <div class="bg-gray-50 dark:bg-slate-900/50 p-4 rounded-lg">
                        ...
                        <div class="space-y-2 text-xs">
                            <div class="flex justify-between">
                                ...
                                <span class="text-gray-700 dark:text-gray-300">{{ $berita->created_at ? $berita->created_at->format('d M Y H:i') : '-' }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-500 dark:text-gray-400">Diperbarui:</span>
                                <span class="text-gray-700 dark:text-gray-300">{{ $berita->updated_at ? $berita->updated_at->format('d M Y H:i') : '-' }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-500 dark:text-gray-400">Dilihat:</span>
                                <span class="text-gray-700 dark:text-gray-300">{{ number_format($berita->views ?? 0) }}x</span>
                            </div>
                        </div>
                    </div>
                </div>
