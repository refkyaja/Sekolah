...
<div class="min-h-screen bg-background-light dark:bg-background-dark p-8 pb-8">
    <div class="max-w-7xl mx-auto">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="text-slate-800 dark:text-slate-200 text-sm font-bold">Edit Data Guru</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            <div>
                <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Edit Data Guru</h1>
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Silakan lengkapi formulir di bawah ini untuk mengubah data guru atau staf.</p>
            </div>
