...
<div class="max-w-5xl mx-auto space-y-6">
    <div class="bg-white dark:bg-slate-800 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700 overflow-hidden">
        <form action="{{ route($routePrefix . '.kegiatan.update', $kegiatan) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <label id="banner-container" class="border-2 border-dashed border-slate-200 dark:border-slate-600 rounded-3xl overflow-hidden text-center bg-slate-50/50 dark:bg-slate-800/50 hover:bg-slate-50 dark:hover:bg-slate-700 transition-all group cursor-pointer block relative {{ $kegiatan->banner_path ? 'aspect-video' : 'p-8' }}">
                                <div id="banner-placeholder" class="{{ $kegiatan->banner_path ? 'hidden' : '' }}">
                                    ...
                                    <h4 class="text-sm font-bold text-slate-700 dark:text-slate-300 mb-1">Ganti banner</h4>
