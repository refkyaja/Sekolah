...
<nav aria-label="Breadcrumb" class="flex mb-4 text-xs font-medium text-slate-400 uppercase tracking-widest">
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li><span class="mx-2">/</span></li>
        <li class="text-slate-600">Tambah Data</li>
    </ol>
</nav>

<div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
    <div>
        <h1 class="text-3xl font-bold text-slate-900 tracking-tight">Tambah Data PPDB</h1>
        <p class="text-sm text-slate-500 mt-1">Lengkapi formulir di bawah ini untuk mendaftarkan calon siswa baru.</p>
    </div>
