...
<form action="{{ route('admin.ppdb.update', $spmb) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')

    @php
    $spmbData = $spmb ?? null;
    $dokumenData = $dokumen ?? collect([]);
    
    // Helper to get document
    function getDokumen($jenis, $dokumen) {
        return $dokumen->get($jenis);
    }
    @endphp
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       value="{{ old('nama_lengkap_anak', $spmbData->nama_lengkap_anak ?? '') }}"
                       required
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       value="{{ old('nama_panggilan_anak', $spmbData->nama_panggilan_anak ?? '') }}"
