    ...
    <div class="bg-white dark:bg-slate-800 rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-slate-700">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-100">Edit Data Siswa</h2>
                    <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">Update data siswa: {{ $siswa->nama_lengkap }}</p>
                </div>
                <div class="flex items-center space-x-2">
                    ...
                    @else
                    <div class="h-10 w-10 rounded-full bg-gray-200 dark:bg-slate-700 flex items-center justify-center">
        ...
        <form method="POST" action="{{ route('admin.siswa.siswa-aktif.update', $siswa) }}" enctype="multipart/form-data" class="p-6">
            ...
            <div id="profile" class="tab-content">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <!-- NIS -->
                    <div>
                        <label for="nis" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                            NIS
                        </label>
                    ...
                    <!-- Nama Panggilan -->
                    <div>
                        <label for="nama_panggilan" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                            Nama Panggilan
                        </label>
                    ...
                    <div>
                        ...
                        <select id="agama" name="agama" class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div id="address" class="tab-content hidden">
                <div class="space-y-6">
                    <!-- Alamat Lengkap -->
                    <div>
                        <h4 class="text-md font-medium text-gray-700 dark:text-gray-300 mb-3">Alamat Lengkap</h4>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label for="kota_kabupaten" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Kota/Kabupaten</label>
                            ...
                            <div class="md:col-span-2">
                                <label for="nama_jalan" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nama Jalan, RT/RW</label>
                    ...
                    <div class="pt-6 border-t border-gray-200 dark:border-slate-700">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div>
                                <label for="berat_badan" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Berat Badan (kg)</label>
                                <input type="number" step="0.1" name="berat_badan" id="berat_badan" 
                                       value="{{ old('berat_badan', $siswa->berat_badan) }}"
                                       class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>
                            <div>
                                <label for="tinggi_badan" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tinggi Badan (cm)</label>
                                <input type="number" step="0.1" name="tinggi_badan" id="tinggi_badan" 
                                       value="{{ old('tinggi_badan', $siswa->tinggi_badan) }}"
                                       class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>
                            <div>
                                <label for="golongan_darah" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Golongan Darah</label>
                                <select name="golongan_darah" id="golongan_darah" class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            <div>
                                <label for="penyakit_pernah_diderita" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Penyakit Pernah Diderita</label>
                                <textarea name="penyakit_pernah_diderita" id="penyakit_pernah_diderita" rows="2"
                                          class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('penyakit_pernah_diderita', $siswa->penyakit_pernah_diderita) }}</textarea>
                            </div>
                            <div>
                                <label for="imunisasi" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Imunisasi</label>
                                <textarea name="imunisasi" id="imunisasi" rows="2"
                                          class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('imunisasi', $siswa->imunisasi) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="father" class="tab-content hidden">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="md:col-span-1">
                        <label for="nama_ayah" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    ...
                    <div>
                        <label for="nik_ayah" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">NIK Ayah</label>
                    ...
                    <div>
                        <label for="tempat_lahir_ayah" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tempat Lahir Ayah</label>
                    ...
                    <div>
                        <label for="tanggal_lahir_ayah" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tanggal Lahir Ayah</label>
                    ...
                    <div>
                        <label for="pendidikan_ayah" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Pendidikan Ayah</label>
                        <select name="pendidikan_ayah" id="pendidikan_ayah" class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div>
                        <label for="pekerjaan_ayah" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Pekerjaan Ayah</label>
                        <select name="pekerjaan_ayah" id="pekerjaan_ayah" class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div>
                        <label for="bidang_pekerjaan_ayah" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Bidang Pekerjaan</label>
                    ...
                    <div>
                        <label for="penghasilan_ayah" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Penghasilan per Bulan</label>
                        <select name="penghasilan_ayah" id="penghasilan_ayah" class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div>
                        <label for="no_hp_ayah" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">No. HP Ayah</label>
                    ...
                    <div>
                        <label for="email_ayah" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Email Ayah</label>
            ...
            <div id="mother" class="tab-content hidden">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="md:col-span-1">
                        <label for="nama_ibu" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    ...
                    <div>
                        <label for="nik_ibu" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">NIK Ibu</label>
                    ...
                    <div>
                        <label for="tempat_lahir_ibu" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tempat Lahir Ibu</label>
                    ...
                    <div>
                        <label for="tanggal_lahir_ibu" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tanggal Lahir Ibu</label>
                    ...
                    <div>
                        <label for="pendidikan_ibu" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Pendidikan Ibu</label>
                        <select name="pendidikan_ibu" id="pendidikan_ibu" class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <option value="">Pilih Pendidikan</option>
                    ...
                    <div>
                        <label for="pekerjaan_ibu" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Pekerjaan Ibu</label>
                        <select name="pekerjaan_ibu" id="pekerjaan_ibu" class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <option value="">Pilih Pekerjaan</option>
                    ...
                    <div>
                        <label for="bidang_pekerjaan_ibu" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Bidang Pekerjaan</label>
                    ...
                    <div>
                        <label for="penghasilan_ibu" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Penghasilan per Bulan</label>
                        <select name="penghasilan_ibu" id="penghasilan_ibu" class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <option value="">Pilih Penghasilan</option>
                    ...
                    <div>
                        <label for="no_hp_ibu" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">No. HP Ibu</label>
                    ...
                    <div>
                        <label for="email_ibu" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Email Ibu</label>
            ...
            <div id="academic" class="tab-content hidden">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <!-- Kelompok -->
                    <div>
                        <label for="kelompok" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    ...
                    <!-- Status Siswa -->
                    <div>
                        <label for="status_siswa" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    ...
                    <!-- Tanggal Keluar -->
                    <div>
                        <label for="tanggal_keluar" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tanggal Keluar</label>
                    ...
                    <!-- Jalur Masuk -->
                    <div>
                        <label for="jalur_masuk" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Jalur Masuk</label>
                        <select name="jalur_masuk" id="jalur_masuk" class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div class="md:col-span-3">
                        ...
                        <textarea name="catatan" id="catatan" rows="2"
                                  class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('catatan', $siswa->catatan) }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-8 pt-6 border-t border-gray-200 dark:border-slate-700">
                <h4 class="text-md font-medium text-gray-700 dark:text-gray-300 mb-3">Kontak Utama</h4>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="no_hp_ortu" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    ...
                    <div>
                        <label for="email_ortu" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Email Utama</label>
            ...
            <div class="mt-8 pt-6 border-t border-gray-200 dark:border-slate-700">
                <div class="flex items-center justify-between mb-3">
                    <h4 class="text-md font-medium text-gray-700 dark:text-gray-300">Data Wali (Jika Ada)</h4>
                    <label class="inline-flex items-center">
                        <input type="checkbox" id="punya_wali" name="punya_wali" value="1" 
                               {{ old('punya_wali', $siswa->punya_wali) ? 'checked' : '' }}
                               class="form-checkbox text-blue-600">
                        <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">Punya wali</span>
                    </label>
                </div>
                ...
                <div id="dataWaliContainer" class="grid grid-cols-1 md:grid-cols-3 gap-6 {{ old('punya_wali', $siswa->punya_wali) ? '' : 'hidden' }}">
                    ...
                    <div>
                        <label for="hubungan_wali" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Hubungan dengan Anak</label>
                        <select name="hubungan_wali" id="hubungan_wali" class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div>
                        <label for="nik_wali" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">NIK Wali</label>
                    ...
                    <div>
                        <label for="pekerjaan_wali" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Pekerjaan Wali</label>
                        <input type="text" name="pekerjaan_wali" id="pekerjaan_wali" 
                               value="{{ old('pekerjaan_wali', $siswa->pekerjaan_wali) }}"
                               class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <div>
                        <label for="nomor_telepon_wali" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">No. Telepon Wali</label>
            ...
            <!-- Foto -->
            <div class="mt-8 pt-6 border-t border-gray-200 dark:border-slate-700">
                <h4 class="text-md font-medium text-gray-700 dark:text-gray-300 mb-3">Foto Siswa</h4>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        @if($siswa->foto)
                        <div class="mb-3">
                            <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500 mb-1">Foto saat ini:</p>
                            <img src="{{ asset('storage/' . $siswa->foto) }}" 
                                 alt="{{ $siswa->nama_lengkap }}"
                        ...
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">Kosongkan jika tidak ingin mengubah foto. Format: JPG, PNG (maks. 2MB)</p>
                        @error('foto')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <!-- Image Preview -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Preview Foto Baru</label>
                        <div id="imagePreview" class="border-2 border-dashed border-gray-300 dark:border-slate-600 rounded-lg p-4 flex items-center justify-center">
                            <div class="text-center" id="previewPlaceholder">
                                <i class="fas fa-user text-gray-400 dark:text-gray-500 text-4xl mb-2"></i>
                                <p class="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500">Preview akan muncul di sini</p>
                            </div>
            ...
            <!-- Tombol -->
            <div class="mt-8 pt-6 border-t border-gray-200 dark:border-slate-700 flex justify-between">
                <div>
                    <a href="{{ route('admin.siswa.siswa-aktif.show', $siswa) }}" 
                       class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-slate-700 flex items-center">
                        <i class="fas fa-eye mr-2"></i> Lihat Detail
                    </a>
                </div>
                <div class="flex space-x-3">
                    <a href="{{ route('admin.siswa.siswa-aktif.index') }}" 
                       class="px-6 py-2 border border-gray-300 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-slate-700">
                        Batal
                    </a>
                    <button type="submit" 
...
<script>
    ...
    function showTab(tabName) {
        ...
        document.querySelectorAll('[role="tab"]').forEach(btn => {
            ...
            btn.classList.add('border-transparent');\n            btn.classList.remove('dark:border-blue-500', 'dark:text-blue-500');
        });
        ...
        activeBtn.classList.add('active-tab', 'border-blue-500', 'text-blue-600', 'dark:border-blue-500', 'dark:text-blue-500');
