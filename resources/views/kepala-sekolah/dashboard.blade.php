...
<div class="relative bg-gradient-to-r from-primary to-purple-800 rounded-2xl p-6 sm:p-8 mb-6 sm:mb-8 overflow-hidden min-h-[200px] sm:min-h-[220px] flex items-center shadow-xl shadow-primary/20">
    <div class="relative z-10 max-w-lg">
        ...
        <p class="text-white/80 mb-4 sm:mb-6 leading-relaxed text-sm sm:text-base">
            Selamat datang di dashboard Kepala Sekolah. Akses ringkasan data, pantau operasional sekolah, dan kelola informasi penting.
        </p>
...
<div class="grid grid-cols-12 gap-6 sm:gap-8">
    ...
    <div class="col-span-12 lg:col-span-8 space-y-6 sm:space-y-8">
        ...
        <div id="stats-section" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 scroll-mt-24">
            <a href="{{ route('kepala-sekolah.siswa.siswa-aktif.index') }}" class="bg-white dark:bg-slate-800 p-5 sm:p-6 rounded-2xl shadow-sm hover:shadow-md transition-all border border-slate-100 dark:border-slate-700">
            ...
            <a href="{{ route('kepala-sekolah.guru.index') }}" class="bg-white dark:bg-slate-800 p-5 sm:p-6 rounded-2xl shadow-sm hover:shadow-md transition-all border border-slate-100 dark:border-slate-700">
                <div class="w-10 h-10 rounded-xl bg-purple-100 dark:bg-purple-900/30 text-primary flex items-center justify-center mb-4">
            ...
            <a href="{{ route('kepala-sekolah.absensi.index') }}" class="bg-white dark:bg-slate-800 p-5 sm:p-6 rounded-2xl shadow-sm hover:shadow-md transition-all border border-slate-100 dark:border-slate-700">
                <div class="w-10 h-10 rounded-xl bg-purple-100 dark:bg-purple-900/30 text-primary flex items-center justify-center mb-4">
            ...
            <a href="{{ route('kepala-sekolah.ppdb.index') }}" class="bg-white dark:bg-slate-800 p-5 sm:p-6 rounded-2xl shadow-sm hover:shadow-md transition-all border border-slate-100 dark:border-slate-700">
                <div class="w-10 h-10 rounded-xl bg-purple-100 dark:bg-purple-900/30 text-primary flex items-center justify-center mb-4">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm p-6 sm:p-8 border border-slate-100 dark:border-slate-700">
            <div class="flex items-center justify-between mb-6 sm:mb-8">
                ...
                <a href="{{ route('kepala-sekolah.ppdb.index') }}" class="text-primary text-xs font-bold hover:underline">Lihat Semua</a>
            </div>
    ...
    <div class="col-span-12 lg:col-span-4 space-y-6 sm:space-y-8">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm p-5 sm:p-6 border border-slate-100 dark:border-slate-700 flex flex-col items-center text-center">
            ...
            <a href="{{ route('kepala-sekolah.profile.index') }}" class="w-full py-3 bg-lavender dark:bg-primary/20 text-primary font-bold text-sm rounded-xl hover:bg-primary hover:text-white transition-all">
                Lihat Profil
            </a>
        </div>
    </div>
