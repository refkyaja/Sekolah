    ...
    <header class="sticky top-0 z-50 border-b border-slate-200/80 bg-white/90 backdrop-blur-xl">
        <div class="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-4 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
            <div class="flex items-center gap-3">
                ...
                {{-- Logo Sekolah --}}
                <div class="flex items-center gap-2.5 pl-2 border-l border-slate-100 ml-1">
                    <div class="size-9 bg-primary rounded-xl flex items-center justify-center text-white shrink-0 shadow-sm shadow-primary/20">
                ...
                <div class="sm:hidden">
                    <p class="text-[9px] font-bold uppercase tracking-widest text-primary/70">@yield('directory-eyebrow', 'DIREKTORI')</p>
                    <h1 class="text-base font-extrabold text-slate-900 leading-tight">@yield('directory-title')</h1>
                </div>
            </div>
