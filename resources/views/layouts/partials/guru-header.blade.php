<header class="h-20 flex items-center justify-between px-8 bg-transparent flex-shrink-0">
    ...
    <div class="relative flex-1 max-w-md mx-auto lg:mx-0 lg:mr-auto lg:ml-0">
        ...
        <input class="w-full pl-12 pr-4 py-2.5 bg-white border-none rounded-2xl focus:ring-2 focus:ring-primary/20 text-sm shadow-sm transition-all" placeholder="Search for students, documents..." type="text"/>
    </div>
