<header class="h-20 flex items-center justify-between px-8 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 flex-shrink-0 relative z-50">
    ...
    <div class="flex items-center gap-6">
        ...
        <div class="relative" id="profileDropdown">
            ...
            {{-- Dropdown Menu --}}
            <div id="dropdownMenu" class="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-xl border border-slate-100 py-2 z-[100] hidden">
                ...
                <div class="py-1">
                    {{-- Profile --}}
                    <a href="{{ route('operator.profile.index') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-700 hover:bg-lavender/50 transition-all">
                        <span class="material-symbols-outlined text-primary text-lg">person</span>
                        <span class="font-medium">Profil Saya</span>
                    </a>

                    {{-- Settings --}}
                    <a href="{{ route('operator.profile.settings') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-700 hover:bg-lavender/50 transition-all">
