        ...
        <div class="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-slate-800 dark:text-slate-100">{{ $activities->total() }}</h3>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="flex-1">
                <div class="relative">
                    ...
                    <input type="text" wire:model.live.debounce.300ms="search" 
                        ...
                        class="w-full pl-10 pr-4 py-2 bg-slate-50 dark:bg-slate-900 border-none rounded-xl focus:ring-2 focus:ring-primary/20 text-slate-600 dark:text-slate-300">
                </div>
            </div>
            <div class="w-full md:w-48">
                <input type="date" wire:model.live="date" 
                    class="w-full px-4 py-2 bg-slate-50 dark:bg-slate-900 border-none rounded-xl focus:ring-2 focus:ring-primary/20 text-slate-600 dark:text-slate-300">
            </div>
            <div class="w-full md:w-48">
                <select wire:model.live="role" class="w-full px-4 py-2 bg-slate-50 dark:bg-slate-900 border-none rounded-xl focus:ring-2 focus:ring-primary/20 text-slate-600 dark:text-slate-300">
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-slate-50/50 dark:bg-slate-900/50 border-b border-slate-100 dark:border-slate-700">
                        <th class="px-6 py-4 text-sm font-semibold text-slate-600 dark:text-slate-300">No</th>
                        <th class="px-6 py-4 text-sm font-semibold text-slate-600 dark:text-slate-300">Tanggal & Waktu</th>
                        <th class="px-6 py-4 text-sm font-semibold text-slate-600 dark:text-slate-300">User</th>
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-700">
                    ...
                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-900/50 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <p class="text-sm text-slate-600 dark:text-slate-400 max-w-xs truncate" title="{{ $activity->description }}">
