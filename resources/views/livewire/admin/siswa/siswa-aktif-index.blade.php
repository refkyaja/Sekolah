            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-slate-50 dark:divide-slate-700">
                    ...
                    <tr class="hover:bg-slate-50/50 dark:hover:bg-slate-700/50 transition-colors group">
                        ...
                        <td class="px-3 sm:px-6 py-3 sm:py-4">
                            <span class="inline-flex items-center px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-full text-[10px] sm:text-xs font-bold {{ $siswa->kelompok == 'A' ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400' : 'bg-purple-100 text-primary dark:bg-purple-900/30 dark:text-purple-400' }}">
