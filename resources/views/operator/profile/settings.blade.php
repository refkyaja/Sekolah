...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <section class="settings-card p-6 md:p-8">
        ...
        <div class="grid gap-4 md:grid-cols-2">
            <a href="{{ route('operator.profile.index') }}?tab=password" class="rounded-2xl bg-slate-50 dark:bg-slate-800/80 p-5 transition hover:-translate-y-0.5 hover:shadow-lg">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var themeKey = 'operatorTheme';
        var notificationKey = 'operatorNotificationSettings';
        ...
        function applyTheme(theme) {
            ...
            if (typeof window.applyOperatorTheme === 'function') {
